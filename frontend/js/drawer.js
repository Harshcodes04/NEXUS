    ...
    body.innerHTML = `
      ...
      <div class="drawer-section">
        ...
        <div class="drawer-actions">
          ...
          <button class="drawer-action-btn drawer-action-btn-primary"
                  onclick="if(typeof CommandCenter!=='undefined'){CommandCenter.open('${sat.id}');if(typeof Drawer!=='undefined')Drawer.close();}"
                  ${sat.status === 'EOL' ? 'disabled title="Satellite is EOL"' : ''}>
            <i data-lucide="send"></i> Plan Maneuver
          </button>
        </div>
      </div>
    `;
